...
Query ---->    insert into employees values (101, 'Aman', 'aman@gmail.com', 'IT', 45000, '2026-01010')


Insert Priya and Rahul using one multiple-row INSERT.
Query ----->    insert into employees (Employee_ID, Employee_Name, Email, Department, Salary, Joining_Date) values 
               (102, 'Priya', 'priya@gmail.com', 'HR', 40000, '2026-02-15'),
               (103, "Rahul", 'rahul@gmail.com', 'Sales', 38000, '2026-03012')
...
Query ---->  Select Email, Employee_Name, Department from employees
